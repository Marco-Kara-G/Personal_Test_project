...
-- AddForeignKey
ALTER TABLE "Post" ADD CONSTRAINT "Post_favouriteByIDId_fkey" FOREIGN KEY ("favouriteByIDId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
